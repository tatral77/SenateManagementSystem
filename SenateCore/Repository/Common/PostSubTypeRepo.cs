...
{
    public class PostSubTypeRepo: GenericRepo<PostSubType>, IPostSubTypeRepo
    {
        private readonly SenateDBContext _context;
        private readonly IMapper _mapper;

        public PostSubTypeRepo(SenateDBContext context, IMapper mapper) : base(context, mapper)
        {
